...
- 2026-05-23 V0.5.1 rules/card sync and ECS deployment:
  ...
  - Deployed to ECS `/opt/war-card-game`; PM2 `war-card-game` restarted, public `/healthz` passed, and `.deployed-version` was verified after deployment.
