...
基于 V0.5.3 / 20260612 核心机制与美俄首发卡组/组卡规则的可玩原型。

当前版本围绕前线区/支援区、隐蔽/暴露、前线接敌、前线突破、火力引导、防空拦截、导弹打击和 50 点摧毁得分胜利构建。单位牌均为驻场牌，并拆分为攻击、生命和目标价值；巡航导弹、弹道导弹、战斗机和轰炸机也拥有生命并可被摧毁得分。牌库耗尽不会直接结束游戏。
...
- [V0.5.2 内容快照](./GAME_CONTENT_V0.5.2.md)：上一版机制与卡牌内容快照，当前机制以 `GAME_MECHANICS.md` 为准。
...
- 伴随防空拦截巡航导弹，重型防空拦截战斗机和导弹；F-35A/Su-57 按普通战斗机对地打击处理，不再使用 SEAD/反防空裁决。
