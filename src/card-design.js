...
export const CARD_FIRE_VIDEO_PATHS = {
  us_marine_rifle: `${CARD_FIRE_VIDEO_ROOT}/us_marine_rifle-fire.mp4`,
  us_javelin_team: `${CARD_FIRE_VIDEO_ROOT}/us_javelin_team-fire.mp4`,
  us_stinger_team: `${CARD_FIRE_VIDEO_ROOT}/us_stinger_team-fire.mp4`,
  us_rangers_target: `${CARD_FIRE_VIDEO_ROOT}/us_rangers_target-fire.mp4`,
  us_bradley: `${CARD_FIRE_VIDEO_ROOT}/us_bradley-fire.mp4`,
  us_m1a2: `${CARD_FIRE_VIDEO_ROOT}/us_m1a2-fire.mp4`,
  us_stryker: `${CARD_FIRE_VIDEO_ROOT}/us_stryker-fire.mp4`,
  us_apache: `${CARD_FIRE_VIDEO_ROOT}/us_apache-fire.mp4`,
  us_m109: `${CARD_FIRE_VIDEO_ROOT}/us_m109-fire.mp4`,
  us_himars: `${CARD_FIRE_VIDEO_ROOT}/us_himars-fire.mp4`,
  us_avenger: `${CARD_FIRE_VIDEO_ROOT}/us_avenger-fire.mp4`,
  us_patriot: `${CARD_FIRE_VIDEO_ROOT}/us_patriot-fire.mp4`,
  us_reaper: `${CARD_FIRE_VIDEO_ROOT}/us_reaper-fire.mp4`,
  us_atacms: `${CARD_FIRE_VIDEO_ROOT}/us_atacms-fire.mp4`,
  us_tomahawk: `${CARD_FIRE_VIDEO_ROOT}/us_tomahawk-fire.mp4`,
  us_f35: `${CARD_FIRE_VIDEO_ROOT}/us_f35-fire.mp4`,
  us_f35a_sead: `${CARD_FIRE_VIDEO_ROOT}/us_f35a_sead-fire.mp4`,
  us_b2: `${CARD_FIRE_VIDEO_ROOT}/us_b2-fire.mp4`,
  ru_motostrelki: `${CARD_FIRE_VIDEO_ROOT}/ru_motostrelki-fire.mp4`,
  ru_kornet_team: `${CARD_FIRE_VIDEO_ROOT}/ru_kornet_team-fire.mp4`,
  ru_spetsnaz_target: `${CARD_FIRE_VIDEO_ROOT}/ru_spetsnaz_target-fire.mp4`,
  ru_bmp3m: `${CARD_FIRE_VIDEO_ROOT}/ru_bmp3m-fire.mp4`,
  ru_t90m: `${CARD_FIRE_VIDEO_ROOT}/ru_t90m-fire.mp4`,
  ru_bmpt: `${CARD_FIRE_VIDEO_ROOT}/ru_bmpt-fire.mp4`,
  ru_ka52_unit: `${CARD_FIRE_VIDEO_ROOT}/ru_ka52_unit-fire.mp4`,
  ru_2s19: `${CARD_FIRE_VIDEO_ROOT}/ru_2s19-fire.mp4`,
  ru_tornado_s: `${CARD_FIRE_VIDEO_ROOT}/ru_tornado_s-fire.mp4`,
  ru_pantsir: `${CARD_FIRE_VIDEO_ROOT}/ru_pantsir-fire.mp4`,
  ru_buk_m3: `${CARD_FIRE_VIDEO_ROOT}/ru_buk_m3-fire.mp4`,
  ru_orlan10: `${CARD_FIRE_VIDEO_ROOT}/ru_orlan10-fire.mp4`,
  ru_kalibr: `${CARD_FIRE_VIDEO_ROOT}/ru_kalibr-fire.mp4`,
  ru_iskander: `${CARD_FIRE_VIDEO_ROOT}/ru_iskander-fire.mp4`,
  ru_su35: `${CARD_FIRE_VIDEO_ROOT}/ru_su35-fire.mp4`,
  ru_su57_sead: `${CARD_FIRE_VIDEO_ROOT}/ru_su57_sead-fire.mp4`,
  ru_su34: `${CARD_FIRE_VIDEO_ROOT}/ru_su34-fire.mp4`,
};
