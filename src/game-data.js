...
const MISSILE_TAGS = [...MISSILE_TARGET_TAGS];
...
const GROUND_OR_LOW_AIR_TARGET_TAGS = [...GROUND_UNIT_TAGS, ...GROUND_SUPPORT_TAGS, ...LOW_AIR_TAGS];
const MISSILE_LEGAL_TARGET_TAGS = [...GROUND_UNIT_TAGS, ...GROUND_SUPPORT_TAGS, "直升机"];
...
const V07_CARD_OVERRIDES = {
  ...
  "us_f35a_sead": {
    ...
    "tags": ["战斗机", "SEAD"],
    "effect": "【SEAD反辐射压制】：指定敌方【伴随防空】或【重型防空】，含隐蔽单位，造成 5 点伤害。\n【有限制空】：若找不到有效防空目标，对一个低空或高空目标造成 4 点伤害。",
    "art": "us_f35a_sead",
    "ability": {
      "kind": "damage",
      "rows": ["frontline", "support"],
...
const DOCX_20260521_CARD_PATCHES = {
  "us_javelin_team": unitPatch({
    ...
    "effect": "【反甲伏击】：对前线地面目标造成 2 点伤害；若目标为【装甲】，伤害+2。\n【前线伏击】：隐蔽部署后因前线接敌被动打击时，伤害+1。",
    "ability": {
      "kind": "damage",
      "rows": ["frontline"],
      "amount": 2,
  ...
  "us_rangers_target": unitPatch({
    ...
    "displayTags": ["侦察兵"],
    "unitAttribute": "侦察兵",
    "ruleNote": "【侦察兵】：被作为目标时，算作步兵。\n【渗透作战】：本单位不会因前线接敌而暴露。",
    "effect": "【坐标引导】：选择一个隐蔽目标，使其暴露。若目标为地面或低空单位，且己方有本回合未行动的【榴弹炮】或【火箭炮】，可立即对该目标进行一次打击；否则抽 1 张牌。",
    "ability": {
      "kind": "exposeAndCallFire",
      "rows": ["frontline", "support"],
      "canRevealHidden": true,
      "hiddenOnly": true,
      "callerTags": ["榴弹炮", "火箭炮"],
      "callFireTargetTags": GROUND_OR_LOW_AIR_TARGET_TAGS,
      "noCallerFallback": "draw",
      "fallbackDraw": 1,
      "sourceExposes": true
    },
  ...
  "us_bradley": unitPatch({
    ...
    "effect": "【伴随火力】：对前线地面目标造成 3 点伤害；若目标为【步兵】，伤害+1。",
  ...
  "us_m1a2": unitPatch({
    ...
    "unitAttribute": "装甲",
    "ruleNote": "【装甲】：可以攻击前线区地面单位。\n【前线突破】：若敌方前线为空，可突破暴露一个隐蔽支援单位。",
    "effect": "【装甲突击】：对前线地面目标造成 4 点伤害；若目标为【装甲】，伤害+1。\n【协同推进】：若己方前线有【步兵】，伤害+1。",
    "canBreakthrough": true,
    "ability": {
      "kind": "damage",
      "rows": ["frontline"],
  ...
  "us_reaper": unitPatch({
    ...
    "ruleNote": "【无人机】：无法攻击。",
    "effect": "【无人侦扫】：选择一个隐蔽目标，使其暴露。\n【火力校射】：若目标为地面或低空单位，且己方有本回合未行动的【榴弹炮】或【火箭炮】，可立即对该目标进行一次打击；否则抽 1 张牌。",
    "ability": {
      "kind": "exposeAndCallFire",
      "rows": ["frontline", "support"],
      "canRevealHidden": true,
  ...
  "us_tomahawk": unitPatch({
    ...
    "displayTags": ["巡航导弹"],
    "unitAttribute": "巡航导弹",
    "ruleNote": "【巡航导弹】：可以攻击所有战线地面单位和直升机；不能攻击无人机、高空单位或对方导弹。",
    "effect": "【巡航打击】：对一个地面或直升机目标造成 4 点伤害，若目标在前线，伤害+1。",
    "ability": {
      "kind": "damage",
      "rows": ["frontline", "support"],
  ...
  "us_atacms": unitPatch({
    ...
    "displayTags": ["弹道导弹"],
    "unitAttribute": "弹道导弹",
    "ruleNote": "【弹道导弹】：可以攻击所有战线地面单位和直升机；不能攻击无人机、高空单位或对方导弹。只有重型防空可拦截。",
    "effect": "【弹道打击】：对一个地面或直升机目标造成 5 点伤害，若目标在前线，伤害+1。",
    "ability": {
      "kind": "damage",
      "rows": ["frontline", "support"],
      "amount": 5,
      "lineAmounts": { "frontline": 6 },
      "requiresAnyTag": MISSILE_LEGAL_TARGET_TAGS,
      "sourceExposes": true,
      "interceptByTags": ["重型防空"]
    }
  ...
  "us_f35a_sead": unitPatch({
    ...
    "unitAttribute": "战斗机、高空",
    "tags": ["战斗机", "SEAD"],
    "effect": "【SEAD反辐射压制】：目标为【伴随防空】或【重型防空】时，伤害+3，并可锁定隐蔽防空单位。\n【有限制空】：若目标为低空或高空单位，伤害+1。",
    "ability": {
      "kind": "damage",
      "rows": ["frontline", "support"],
      "amount": 2,
  ...
  "ru_orlan10": unitPatch({
    ...
    "unitAttribute": "无人机、低空",
    "ruleNote": "【无人机】：无法攻击。",
    "effect": "【无人侦扫】：选择一个隐蔽目标，使其暴露。\n【炮兵校射】：若目标为地面或低空单位，且己方有本回合未行动的【榴弹炮】或【火箭炮】，可立即对该目标进行一次打击；否则抽 1 张牌。",
    "ability": {
      "kind": "exposeAndCallFire",
      "rows": ["frontline", "support"],
      "canRevealHidden": true,
  ...
  "ru_pantsir": unitPatch({
    ...
    "displayTags": ["伴随防空"],
    "unitAttribute": "伴随防空",
    "effect": "【野战防空】：若目标为低空单位，伤害+1。\n【伴随拦截】：敌方【巡航导弹】打击造成的伤害无效，一回合一次。（隐蔽部署时也生效，生效后自身暴露）",
    "ability": {
      "kind": "damage",
      "rows": ["frontline", "support"],
      "amount": 2,
  ...
  "ru_iskander": unitPatch({
    ...
    "unitAttribute": "弹道导弹",
    "ruleNote": "【弹道导弹】：可以攻击所有战线地面单位和直升机；不能攻击无人机、高空单位或对方导弹。只有重型防空可拦截。",
    "effect": "【弹道导弹】：对一个地面或直升机目标造成 5 点伤害，若目标在前线，伤害+1。",
    "ability": {
      "kind": "damage",
      "rows": ["frontline", "support"],
      "amount": 5,
  ...
  "ru_su34": unitPatch({
    ...
    "unitAttribute": "轰炸机、高空",
    "tags": ["轰炸机"],
    "effect": "【对地空袭】：选择最多两个目标造成伤害，主目标 5 点，第二目标 3 点。",
    "ability": {
      "kind": "areaDamage",
      "rows": ["frontline", "support"],
      "amount": 5,
...
const DOCX_20260523_DISPLAY_TEXT_PATCHES = {
  "us_javelin_team": {
    "name": "标枪反甲小组",
    "displayTags": ["步兵"],
    "unitAttribute": "步兵",
    "ruleNote": "步兵：可以攻击地面单位。伏击：隐蔽部署时因前线接敌触发反击时，伤害+1。",
    "effect": "伏击若目标为装甲，伤害+2。"
  },
  "us_stinger_team": {
    "name": "毒刺防空组",
    "displayTags": ["步兵"],
    "unitAttribute": "步兵",
    "ruleNote": "步兵：可以攻击地面单位。高射：可以攻击低空目标。",
    "effect": "高射若目标为低空单位，伤害+3。",
    "ability": {
      "kind": "damage",
      "rows": ["frontline", "support"],
      "amount": 1,
      "requiresAnyTag": [...GROUND_UNIT_TAGS, ...LOW_AIR_TAGS],
      "bonuses": LOW_AIR_TAGS.map((tag) => ({ tag, amount: 4 })),
      "sourceExposes": true
    }
  },
  "us_marine_rifle": {
    ...
    "displayTags": ["步兵"],
    "unitAttribute": "步兵",
    "ruleNote": "步兵：可以攻击地面单位。",
    "effect": "若目标为步兵，伤害+1。若己方前线有装甲，伤害+1。"
  },
  "us_rangers_target": {
    "name": "游骑兵渗透小组",
    "displayTags": ["步兵"],
    "unitAttribute": "步兵",
    "ruleNote": "步兵：可以攻击地面单位。侦察：选定任意目标，若为隐蔽单位则使其暴露。渗透：本单位不会因前线接敌而暴露。",
    "effect": "渗透侦察一个目标，若为地面或低空单位，使友方未行动的一个火箭炮、榴弹炮立即攻击一次，否则抽 1 张牌。"
  },
  "us_bradley": {
    "name": "布莱德利步兵战车",
    "displayTags": ["装甲"],
    "unitAttribute": "装甲",
    "ruleNote": "装甲：可以攻击地面单位，可执行前线突破。",
    "effect": "若目标为步兵，伤害+1。"
  },
  "us_stryker": {
    "name": "斯特赖克机动装甲",
    "displayTags": ["装甲"],
    "unitAttribute": "装甲",
    "ruleNote": "装甲：可以攻击地面单位，可执行前线突破。高射：可以攻击低空目标。",
    "effect": "高射若目标为步兵，伤害+1。"
  },
  "us_m1a2": {
    "name": "艾布拉姆斯主战坦克",
    "displayTags": ["装甲"],
    "unitAttribute": "装甲",
    "ruleNote": "装甲：可以攻击地面单位，可执行前线突破。",
    "effect": "若目标为装甲，伤害+1。若己方前线有步兵，伤害+1。"
  },
  "us_apache": {
    "name": "阿帕奇武装直升机",
    "displayTags": ["直升机", "低空"],
    "unitAttribute": "直升机、低空",
    "ruleNote": "直升机：可以攻击地面和低空单位，可执行前线突破。",
    "effect": "若目标为装甲、直升机，伤害+2。"
  },
  "us_reaper": {
    "name": "死神侦察无人机",
    "displayTags": ["无人机", "低空"],
    "unitAttribute": "无人机、低空",
    "ruleNote": "无人机：无法攻击。侦察：选定任意目标，若为隐蔽单位则使其暴露。",
    "effect": "侦察一个目标，若为地面或低空单位，使友方本回合未行动的一个远火单位立即攻击一次，否则抽 1 张牌。"
  },
  "us_avenger": {
    "name": "复仇者伴随防空",
    "displayTags": ["伴随防空"],
    "unitAttribute": "伴随防空",
    "ruleNote": "伴随防空：可以攻击低空和高空单位。",
    "effect": "若目标为低空单位，伤害+1。拦截敌方巡航导弹的攻击，一回合一次。（隐蔽部署时也生效，生效后自身暴露）"
  },
  "us_patriot": {
    "name": "爱国者防空导弹",
    "displayTags": ["重型防空"],
    "unitAttribute": "重型防空",
    "ruleNote": "重型防空：可以攻击高空单位。",
  ...
  "us_himars": {
    ...
    "effect": "选择最多两个目标，对次要目标造成1点伤害，若目标为步兵，伤害+1。"
  },
  "us_m109": {
    "name": "帕拉丁榴弹炮",
    "displayTags": ["榴弹炮"],
    "unitAttribute": "榴弹炮",
    "ruleNote": "榴弹炮：可以攻击地面和低空单位。",
    "effect": "若目标为步兵，伤害+1。"
  },
  "us_tomahawk": {
    "name": "战斧巡航导弹",
  ...
  "us_b2": {
    ...
    "displayTags": ["轰炸机", "高空"],
    "unitAttribute": "轰炸机、高空",
    "ruleNote": "轰炸机：可以攻击地面单位，一次攻击多个目标。",
    "effect": "选择最多两个目标，对次要目标造成3点伤害。"
  },
  "us_f35": {
    "name": "F-22 战斗机",
    "displayTags": ["战斗机", "高空"],
  ...
  "us_electronic_suppression": {
    "name": "电子压制",
    "displayTags": ["战术"],
    "ruleNote": "战术：一次性触发，然后进入弃牌堆。干扰：受影响的目标不能行动，持续一回合。",
    "effect": "干扰一个目标。"
  },
  "us_emergency_supply": {
    "name": "紧急补给",
    "displayTags": ["战术"],
    "ruleNote": "战术：一次性触发，然后进入弃牌堆。",
    "effect": "抽 3 张牌，选择 1 张加入手牌，其余放回牌库底。"
  },
  "us_smoke_screen": {
    "name": "烟幕掩护",
...
Object.entries(DOCX_20260523_DISPLAY_TEXT_PATCHES).forEach(([cardId, patch]) => {
  const card = CARD_LIBRARY[cardId];
  if (card) {
    Object.assign(card, patch);
  }
